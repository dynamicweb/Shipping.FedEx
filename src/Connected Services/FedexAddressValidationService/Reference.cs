...
namespace Dynamicweb.Ecommerce.ShippingProviders.FedEx.FedexAddressValidationService
{
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.2")]
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://fedex.com/ws/addressvalidation/v3", ConfigurationName="FedexAddressValidationService.AddressValidationPortType")]
    internal interface AddressValidationPortType
    {
        
        // CODEGEN: Generating message contract since the operation addressValidation is neither RPC nor document wrapped.
        [System.ServiceModel.OperationContractAttribute(Action="http://fedex.com/ws/addressvalidation/v3/addressValidation", ReplyAction="*")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        FedexAddressValidationService.addressValidationResponse addressValidation(FedexAddressValidationService.addressValidationRequest1 request);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://fedex.com/ws/addressvalidation/v3/addressValidation", ReplyAction="*")]
        System.Threading.Tasks.Task<FedexAddressValidationService.addressValidationResponse> addressValidationAsync(FedexAddressValidationService.addressValidationRequest1 request);
    }
    
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.2")]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.Xml.Serialization.XmlTypeAttribute(Namespace="http://fedex.com/ws/addressvalidation/v3")]
    ...
    internal partial class addressValidationRequest1
    {
        
        [System.ServiceModel.MessageBodyMemberAttribute(Namespace="http://fedex.com/ws/addressvalidation/v3", Order=0)]
        public FedexAddressValidationService.AddressValidationRequest AddressValidationRequest;
        
        public addressValidationRequest1()
        {
        }
        
        public addressValidationRequest1(FedexAddressValidationService.AddressValidationRequest AddressValidationRequest)
        {
    ...
    [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
    [System.ServiceModel.MessageContractAttribute(IsWrapped=false)]
    internal partial class addressValidationResponse
    {
        
        [System.ServiceModel.MessageBodyMemberAttribute(Namespace="http://fedex.com/ws/addressvalidation/v3", Order=0)]
        public FedexAddressValidationService.AddressValidationReply AddressValidationReply;
        
        public addressValidationResponse()
        {
        }
        
        public addressValidationResponse(FedexAddressValidationService.AddressValidationReply AddressValidationReply)
        {
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.2")]
    internal interface AddressValidationPortTypeChannel : FedexAddressValidationService.AddressValidationPortType, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.2")]
    internal partial class AddressValidationPortTypeClient : System.ServiceModel.ClientBase<FedexAddressValidationService.AddressValidationPortType>, FedexAddressValidationService.AddressValidationPortType
    {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        FedexAddressValidationService.addressValidationResponse FedexAddressValidationService.AddressValidationPortType.addressValidation(FedexAddressValidationService.addressValidationRequest1 request)
        {
            return base.Channel.addressValidation(request);
        }
        
        public FedexAddressValidationService.AddressValidationReply addressValidation(FedexAddressValidationService.AddressValidationRequest AddressValidationRequest)
        {
            FedexAddressValidationService.addressValidationRequest1 inValue = new FedexAddressValidationService.addressValidationRequest1();
            inValue.AddressValidationRequest = AddressValidationRequest;
            FedexAddressValidationService.addressValidationResponse retVal = ((FedexAddressValidationService.AddressValidationPortType)(this)).addressValidation(inValue);
            return retVal.AddressValidationReply;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<FedexAddressValidationService.addressValidationResponse> FedexAddressValidationService.AddressValidationPortType.addressValidationAsync(FedexAddressValidationService.addressValidationRequest1 request)
        {
            return base.Channel.addressValidationAsync(request);
        }
        
        public System.Threading.Tasks.Task<FedexAddressValidationService.addressValidationResponse> addressValidationAsync(FedexAddressValidationService.AddressValidationRequest AddressValidationRequest)
        {
            FedexAddressValidationService.addressValidationRequest1 inValue = new FedexAddressValidationService.addressValidationRequest1();
            inValue.AddressValidationRequest = AddressValidationRequest;
            return ((FedexAddressValidationService.AddressValidationPortType)(this)).addressValidationAsync(inValue);
        }
        ...
        private static System.ServiceModel.EndpointAddress GetEndpointAddress(EndpointConfiguration endpointConfiguration)
        {
            if ((endpointConfiguration == EndpointConfiguration.AddressValidationServicePort))
            {
                return new System.ServiceModel.EndpointAddress("https://wsbeta.fedex.com/web-services/addressvalidation");
            }
            throw new System.InvalidOperationException(string.Format("Could not find endpoint with name \'{0}\'.", endpointConfiguration));
        }
